...
"""
The CLCD dataset consists of 600 pairs image of cropland change samples. Each group of samples is 
composed of two images and a corresponding binary label of cropland change. The main types of change 
annotated in CLCD include buildings, roads, lakes and bare soil lands, etc.
"""

class CLCDDataset(BaseDataset):

    url = "https://github.com/liumency/CropLand-CD"
    name = "CLCD"
    schema = FAIREOSchema
