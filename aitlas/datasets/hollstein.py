...
class HollsteinDataset(SemanticSegmentationDataset):
    ...
    labels = [
        ...
        "cloud",
        "snow",
    ]  # add the no_data class to start at 0
    color_mapping = [
        [0, 0, 0],
        [255, 255, 255],
        [0, 0, 128],
    ...
    def __getitem__(self, index):
        ...
        masks = [
            (mask == v * 10) for v, label in enumerate(self.labels)
        ]  # the label values are actually 10, 20, 30, 40, 50, 60
    ...
    def load_dataset(self, data_dir, csv_file=None):
        ...
        self.masks = [
            os.path.join(data_dir, "masks_before_reclassification", "mask_" + image_id)
            for image_id in ids
        ]
