...
class CESBIODataset(SemanticSegmentationDataset):
    ...
    labels = ["no-data","not used","low clouds","high clouds","cloud shadows","land","water","snow"]
    color_mapping = [[0,0,0],[128,128,128],[0,0,255],[0,255,255],[192,192,192],[0,128,0],[0,0,128],[255,255,255]] 
    name = "CESBIO"
