...
"""
35 reference cloud masks generated by an active learning method for 36 Sentinel-2 scenes over 10 sites: Alta Floresta (Brazil),
Arles (France), Ispra (Italy), Munich (Germany), Orleans (France), Gobabeb (Namibia), Marrakech (Morocco), Railroad Valley (USA),
Pretoria (South AFrica) and Mongu (Zambia). The scenes are collected for different seasons and cloud cover types.
"""


class CESBIODataset(SemanticSegmentationDataset):
    url = "https://drive.google.com/drive/folders/1M0dYz7Afkm471cea0-ez5UhLl4MvcnMI?usp=sharing"
