...
class BITModel(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=2, pretrained=True, token_len=4,
        ...
        resnet = resnet18_dilated(pretrained=pretrained, replace_stride_with_dilation=[False, True, True])
        ...
        self.transformer_encoder = Transformer(
            dim=dim, depth=enc_depth, heads=8, dim_head=dim_head, 
            mlp_dim=mlp_dim, dropout=0
        )
        self.transformer_decoder = TransformerDecoder(
            dim=dim, depth=dec_depth, heads=8, dim_head=decoder_dim_head, 
