...
def load_weights(model: CROMAModule, weights: WeightsEnum) -> None:
...
def croma_base(
    ...
    * https://arxiv.org/abs/2311.00566
    ...
    Args:
        ...
        *args: Additional arguments to pass to :class:CROMAModule.`
        **kwargs: Additional keyword arguments to pass to :class:CROMAModule.`
