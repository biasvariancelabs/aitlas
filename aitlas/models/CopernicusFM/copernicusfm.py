...
class CopernicusFM_Large_Weights(WeightsEnum):  # type: ignore[misc]
...
def copernicusfm_large(
    weights: CopernicusFM_Large_Weights | None = None, *args: Any, **kwargs: Any
) -> CopernicusFMModule:
    """CopernicusFM vit-large model.
