...
.. toctree::
    ...
    examples/multiclass_classification_example_eurosat.ipynb
    examples/multiclass_classification_example_pattern_net.ipynb
    examples/multiclass_classification_example_resisc45.ipynb
    examples/multiclass_classification_example_rsd46_whu.ipynb
    examples/multiclass_classification_example_rsi_cb256.ipynb
    examples/multiclass_classification_example_rsscn7.ipynb
    examples/multiclass_classification_example_sat6.ipynb
    examples/multiclass_classification_example_siri_whu.ipynb
    examples/multiclass_classification_example_uc_merced.ipynb
...
.. toctree::
    ...
    examples/multilabel_classification_example_big_earth_net_43.ipynb
    examples/multilabel_classification_example_dfc15.ipynb
    examples/multilabel_classification_example_mlrs_net.ipynb
    examples/multilabel_classification_example_planet_uas.ipynb
    examples/multilabel_classification_example_uc_merced.ipynb
...
.. toctree::
    ...
    examples/semantic_segmentation_example_camvid.ipynb
    examples/semantic_segmentation_example_chactun.ipynb
    examples/semantic_segmentation_example_inria.ipynb
    examples/semantic_segmentation_example_landcover_ai.ipynb
    examples/semantic_segmentation_example_massachusetts_buildings.ipynb
