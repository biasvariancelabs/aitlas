...
def test_instantiation_croma_local(mock_backbone_cls, mock_os_exists, mock_torch_load, config_croma_base):
...
def test_instantiation_croma_download(
    mock_backbone_cls, mock_os_exists, mock_torch_load, mock_hf_download, config_croma_base
):
...
def test_forward_pass_croma_full(
    ...
    config_croma_base, dummy_croma_input
):
    ...
    expected_keys = ["SAR_encodings", "SAR_GAP", "optical_encodings", "optical_GAP", "joint_GAP"]
...
def test_forward_pass_croma_modality_update(
    mock_backbone_cls, mock_os_exists, mock_torch_load, 
    config_croma_base, dummy_croma_input_sar_only
):
