...
@patch('aitlas.models.panopticon_wrapper.panopticon_base', side_effect=MockPanopticonBackbone)
def test_instantiation_panopticon_local(mock_backbone_cls, mock_os_exists, mock_torch_load, config_panopticon_base):
    ...
    mock_torch_load.assert_called_with(config_panopticon_base["local_model_path"], weights_only=False)
...
def test_instantiation_panopticon_download(
    mock_backbone_cls, mock_os_exists, mock_torch_load, mock_hf_download, config_panopticon_base
):
...
def test_forward_pass_panopticon_pooled(
    ...
    config_panopticon_base, dummy_panopticon_input
):
