...
from aitlas.models.SatMAE_plusplus.models_mae_group_channels import (
...
@pytest.mark.parametrize(
    "backbone_name",
    [
        "unsupported_vit_model",
        "mae_vit_base",
    ],  # mae_vit_base is a valid model but not listed in the checkpoints dict
)
