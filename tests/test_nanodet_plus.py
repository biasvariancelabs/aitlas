...
def nanodet_plus_model():
    """
    A pytest fixture that instantiates the NanoDetPlus once per test module.
    """
    mock_config = {
        "pretrained": True,
        "num_classes": 20,
...
def test_nanodet_plus_train_forward_pass(nanodet_plus_model):
    """
    Test the forward pass of the NanoDetPlus model in training mode.
    """
    nanodet_plus_model.model.train()
    batch_size = 2
    channels = 3
    height = 512
    width = 512
